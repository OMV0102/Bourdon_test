...
namespace Bourdon_test
{
    public partial class Form_rules : Form
    {
        ...
        private void boxDifficulty_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtRules.Text += "* В ходе данного тестирования вам будет предложена одна таблица с " + size + " строками,\n  по " + size + " цифр в каждой.\n";
            txtRules.Text += "* Вы должны находить и отмечать " + strNumeric + " именно, вам будет\n  сообщено далее на окне тестирования.\n";
            txtRules.Text += "* Вам необходимо работать внимательно и отмечать только приведенные цифры.\n  Выбор цифры осуществляется путем клика по ячейке таблицы.\n";
            txtRules.Text += "* Просматривать таблицу следует построчно, слева-направо. Возврат по тесту назад\n  невозможен. Выбранные и пропущенные вами ячейки становятся неактивными.\n";
            if (level == 2 || level == 3)
            ...
            txtRules.Text += "* После окончания нажмите кнопку \"Закончить\".";
        }
    }
}
